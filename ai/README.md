...
| [`BUILD_SUMMARY.md`](BUILD_SUMMARY.md) | How the build came together: the decisions made resolving the SI against the template, bugs found and fixed, the feature work, Phase 1, and how the two were merged | Living — append as work lands |
...
| [`260901_Phase 1 Detailed Plan.md`](260901_Phase%201%20Detailed%20Plan.md) | File-level and signature-level plan for Phase 1 (persistence reliability) | Implemented and merged with the feature work; builds and all 125 tests pass; manual checklist outstanding |
